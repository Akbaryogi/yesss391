...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText:  `${wibu}`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
...
   case 'command':
               list = []
               listmenu = [`groupmenu`,`photoxy`,`ephoto`,`storymenu`,`soundmenu`,`randomtext`,`islammenu`,`stickermenu`,`ownermenu`,`gamemenu`,`funmenu`,`downloadmenu`,`infomenu`,`othermenu`,`owner`,`gc`,`sewabot`]
               listmenuu = [`Menu Group`,`Photo Oky`,`Ephoto Menu`,`Movie&Story`,`Sound Menu`,`RandomText`,`Islam Menu`,`Sticker Menu`,`Owner Command`,`Game Menu`,`For Fun Menu`,`Downloader`,`Info Menu`,`Menu Lainnya`,`OwnerBot`,`Group Bot`,`Rent this Bot`]
               nombor = 1
               startnum = 0
...
│❏ https://chat.whatsapp.com/DVVDApg787K5WiPZyjzR7Q
╰────

╭──「 *_Payment Akbar Store_* 」
│❏   HARAP TF SESUAI NOM
╰────
╭─ [Dana, Ovo, Spay ]
╭─ [Gopay,Tanya owner
